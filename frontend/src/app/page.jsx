    ...
    <>
      ...
      <section className='min-h-screen'>
        <div className='text-center space-y-5 pt-28'>
          ...
          <button className='bg-[#4B53FB] text-white text-center text-xl px-4 py-2 rounded-2xl'>Get Started</button>
      ...
      <section className='py-20 bg-[#010305] my-5 text-white'>
        <div className='max-w-6xl mx-auto '>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8 mt-10'>
            <div className='border border-[#419EE3] hover:shadow-2xl hover:shadow-[#419ee3] p-6 space-y-2 rounded-lg hover:scale-95 transition-scale duration-300'>
            ...
            <div className='border border-[#419EE3] p-6 space-y-2 hover:shadow-2xl hover:shadow-[#419ee3] rounded-lg hover:scale-95 transition-scale duration-300'>
              <p className='text-left text-4xl'>💻</p>
      ...
      <section className='py-20 bg-[#010305] my-5 text-white'>
        <div className='max-w-6xl mx-auto '>
          ...
          <div className='grid grid-cols-1 md:grid-cols-4 gap-8 mt-16'>
            ...
            <div className='space-y-2  text-center'>
              <h1 className='border rounded-full w-12 ml-28 px-5 py-3 bg-[#419EE3]'>4</h1>
        ...
        <div className='max-w-6xl mx-auto'>
            ...
            <div className='flex justify-center items-center gap-36 mt-10'>
              ...
              <div className='space-y-4'>
                <div className=''>
                  <h1 className='text-xl'><span className='text-[#419EE3]'>✓</span> Time Efficiency</h1>
                  <p className='text-[#99A1AF]'>Reduce documentation time by up to 70% with AI-powered automation.</p>
                </div>
                <div>
                  <h1 className='text-xl'><span className='text-[#419EE3]'>✓</span> Consistency & Quality</h1>
                  <p className='text-[#99A1AF]'>Reduce documentation time by up to 70% with AI-powered automation.</p>
                </div>
                <div>
                  <h1 className='text-xl'><span className='text-[#419EE3]'>✓</span> Up-to-Date Documentation</h1>
                  <p className='text-[#99A1AF]'>Automatically detect code changes and update documentation accordingly.</p>
                </div>
                <div>
                  <h1 className='text-xl'><span className='text-[#419EE3]'>✓</span> Team Productivity</h1>
